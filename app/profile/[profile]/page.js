      ...
      {typeof startIndex === "number" ? (
        <>
          ...
          >
            <button
              ...
              className="absolute h-12 top-0 left-0 mx-2 my-4 hover:opacity-50 transition ease-in-out duration-300 rounded-lg p-2"
            >
        ...
        <>
          <button
            ...
            className="absolute h-12 top-0 left-0 mx-2 my-4 rounded-lg p-2 hover:opacity-50 transition ease-in-out duration-300"
          >
            <IoMdArrowBack size="auto" />
          </button>
