        ...
        <div className="w-full hd-screen bg-slate-950 flex flex-col">
          {typeof startIndex === "number" ? (
              ...
              {ytPlayer.ytReady ? (
                <>
                  ...
                  <button
                    ...
                    className="fixed z-20 h-12 w-12 top-0 left-0 mx-2 my-4 hover:opacity-50 transition ease-in-out duration-300 rounded-lg p-2 text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cue"
            ...
            <>
              <button
                onClick={handleBack}
                className="absolute h-12 w-12 top-0 left-0 mx-2 my-4 rounded-lg p-2 hover:opacity-50 transition ease-in-out duration-300 text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cue"
                aria-label="Go back"
              >
                <IoMdArrowBack size="100%" />
              </button>
              ...
              {transitions.length > 0 ? (
                ...
                <div className="flex grow place-self-center items-center text-center px-6">
                  <div className="text-white/60">
                    ...
                    <p className="mt-1 text-sm">
                      {canDelete
                        ? "Upload your first hand-off and it'll show up here."
                        : "This crate is empty — check back soon."}
                    </p>
                  </div>
                </div>
              )}
